...
const App: React.FC = () => {
  ...
  if (!currentBusiness) {
   ...
   const renderPage = () => {
    switch (currentPage) {
      case Page.Dashboard: 
        return <Dashboard appointments={appointments} clients={clients} services={services} expenses={expenses} onUpdateAppointment={handleUpdateAppointment} onDeleteAppointment={handleDeleteAppointment} />;
